/* Premium interaction layer — visuals live in CSS, business logic stays in card-core.js. */
(()=>{
  ...
  if(!document.querySelector('link[data-card-theme="ocean-luminous"]')){
    ...
    theme.href='card-luminous.css';
    theme.dataset.cardTheme='ocean-luminous';
    document.head.appendChild(theme);
  }

  const iconMarkup={
    vida:'<path d="M12 2.8 19 5.5v5.8c0 4.4-2.8 7.7-7 9.9-4.2-2.2-7-5.5-7-9.9V5.5z"/><path d="M12 15.6s-3.7-2.1-3.7-4.5a2.35 2.35 0 0 1 4.2-1.45 2.35 2.35 0 0 1 4.2 1.45c0 2.4-3.7 4.5-3.7 4.5" transform="translate(-.5 0)"/>',
    ...
    if(qr && !reduce.matches){
      ...
      const closeQr=()=>{
        ...
        const animation=qr.animate([
          ...
          {opacity:.7,transform:'translateY(7px) scale(.988)'},
          {opacity:0,transform:'translateY(16px) scale(.96)'}
        ],{duration:250,easing:'cubic-bezier(.4,0,.6,1)'});
